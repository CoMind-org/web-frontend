...
export default function ProjectCard({ name, description, lastActive }: ProjectCardProps) {
    return (
        <div className="group w-90 h-55 bg-[#010022] rounded-lg border border-blue-500/20 px-6 py-5 hover:border-blue-500/50 cursor-pointer transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="mt-5 border-t border-blue-500/20 pt-4 flex justify-between text-xs text-[#ffffff59]">
